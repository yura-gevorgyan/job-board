!function (s) {
    ...
    var a = 2500, n = 3800, l = n - 3e3, o = 50, h = 150, c = 500, d = c + 800, p = 600, s = 1500;

    function u(t) {
        var e, i, s = g(t);
        t.parents(".banner-headline").hasClass("type") ? ((e = t.parent(".banner-words-wrapper")).addClass("selected").removeClass("waiting"), setTimeout(function () {
            e.removeClass("selected"), t.removeClass("is-visible").addClass("is-hidden").children("i").removeClass("in").addClass("out")
        }, c), setTimeout(function () {
            f(s, h)
        }, d)) : t.parents(".banner-headline").hasClass("letters") ? (i = t.children("i").length >= s.children("i").length, function t(e, i, s, o) {
            ...
            {
                var n;
                e.is(":last-child") && r("html").hasClass("no-csstransitions") && (n = g(i), _(i, n))
            }
        }(t.find("i").eq(0), t, i, o), m(s.find("i").eq(0), s, i, o)) : t.parents(".banner-headline").hasClass("clip") ? t.parents(".banner-words-wrapper").animate({width: "2px"}, p, function () {
            _(t, s), f(s)
        }) : t.parents(".banner-headline").hasClass("loading-bar") ? (t.parents(".banner-words-wrapper").removeClass("is-loading"), _(t, s), setTimeout(function () {
            u(s)
        }, n), setTimeout(function () {
            t.parents(".banner-words-wrapper").addClass("is-loading")
        }, l)) : (_(t, s), setTimeout(function () {
            u(s)
        }, a))
    }

    function f(t, e) {
        t.parents(".banner-headline").hasClass("type") ? (m(t.find("i").eq(0), t, !1, e), t.addClass("is-visible").removeClass("is-hidden")) : t.parents(".banner-headline").hasClass("clip") && t.parents(".banner-words-wrapper").animate({width: t.width() + 10}, p, function () {
            setTimeout(function () {
                u(t)
            }, s)
        })
    ...
    function m(t, e, i, s) {
        t.addClass("in").removeClass("out"), t.is(":last-child") ? (e.parents(".banner-headline").hasClass("type") && setTimeout(function () {
    ...
    r(".banner-headline.letters").find("b").each(function () {
        var t = r(this), e = t.text().split(""), s = t.hasClass("is-visible");
        ...
        t.each(function () {
            ...
            }, l)) : s.hasClass("clip") ? (e = (t = s.find(".banner-words-wrapper")).width() + 10, t.css("width", e)) : s.hasClass("type") || (e = s.find(".banner-words-wrapper b"), i = 0, e.each(function () {
                var t = r(this).width();
                i < t && (i = t)
            }), s.find(".banner-words-wrapper").css("width", i)), setTimeout(function () {
    ...
    f.fn.extend({
        easyResponsiveTabs: function (l) {
            var h = (l = f.extend({
                ...
                }, l)).type, c = l.fit, d = l.width, p = window.location.hash,
            ...
            f(this).on("bind", "tabactivate", function (t, e) {
                ...
                var i, s = f(this), t = s.find("ul.resp-tabs-list." + l.tabidentify), o = s.attr("id");
                s.find("ul.resp-tabs-list." + l.tabidentify + " li").addClass("resp-tab-item").addClass(l.tabidentify), s.css({
                    display: "block",
                    width: d
                }), "vertical" == l.type && t.css("margin-top", "3px"), s.find(".resp-tabs-container." + l.tabidentify).css("border-color", l.active_content_border_color), s.find(".resp-tabs-container." + l.tabidentify + " > div").addClass("resp-tab-content").addClass(l.tabidentify), "vertical" == h && s.addClass("resp-vtabs").addClass(l.tabidentify), 1 == c && s.css({
                    width: "100%",
                    margin: "0px"
                }), "accordion" == h && (s.addClass("resp-easy-accordion").addClass(l.tabidentify), s.find(".resp-tabs-list").css("display", "none")), s.find(".resp-tab-content." + l.tabidentify).before("<h2 class='resp-accordion " + l.tabidentify + "' role='tab'><span class='resp-arrow'></span></h2>"), s.find(".resp-tab-content." + l.tabidentify).prev("h2").css({
                ...
                s.find(".resp-tab-item").each(function () {
                    ...
                    s.find(".resp-tab-content." + l.tabidentify).each(function () {
                        f(this).attr("aria-labelledby", l.tabidentify + "_tab_item-" + t).css({"border-color": l.active_border_color}), t++
                    }), e++
                });
                var r, a = 0;
                "" == p || null !== (r = p.match(new RegExp(o + "([0-9]+)"))) && 2 === r.length && (a = parseInt(r[1], 10) - 1, e < a && (a = 0)), f(s.find(".resp-tab-item." + l.tabidentify)[a]).addClass("resp-tab-active").css({
    ...
    !function () {
        return !!l("transition")
    }() || (o.support.transition = new String(h("transition")), o.support.transition.end = t.transition.end[o.support.transition]), s() && (o.support.animation = new String(h("animation")), o.support.animation.end = t.animation.end[o.support.animation]), e() && (o.support.transform = new String(h("transform")), o.support.transform3d = i())
    ...
    i.fn.counterUp = function (t) {
        ...
        return this.each(function () {
            var l = i(this), h = e;
            l.waypoint(function () {
                for (var t = [], e = h.time / h.delay, i = l.text(), s = /[0-9]+,[0-9]+/.test(i), i = i.replace(/,/g, ""), o = (/^[0-9]+$/.test(i), /^[0-9]+\.[0-9]+$/.test(i)), n = o ? (i.split(".")[1] || []).length : 0, r = e; 1 <= r; r--) {
                ...
                }), setTimeout(l.data("counterup-func"), h.delay), this.destroy()
            }, {offset: "100%"})
        })
    }
}(jQuery), function (f, o, t, m) {
    var s = "stellar", i = {
            ...
            var t, e = /^(Moz|Webkit|Khtml|O|ms|Icab)(?=[A-Z])/, i = f("script")[0].style, s = "";
        ...
        }()("transform"), e = f("<div />", {style: "background:#fff"}).css("background-position-x") !== m,
        g = e ? function (t, e, i) {
    ...
    h.prototype = {
        init: function () {
            ...
            if (this.particles !== m) for (var t = this.particles.length - 1; 0 <= t; t--) this.particles[t].$element.data("stellar-elementIsActive", m);
            this.particles = [], this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function (t) {
                var e, i, s, o, n, r, a, l = f(this), h = 0, c = 0, d = 0, p = 0;
                if (l.data("stellar-elementIsActive")) {
                    if (l.data("stellar-elementIsActive") !== this) return
                } else l.data("stellar-elementIsActive", this);
                u.options.showElement(l), l.data("stellar-startingLeft") ? (l.css("left", l.data("stellar-startingLeft")), l.css("top", l.data("stellar-startingTop"))) : (l.data("stellar-startingLeft", l.css("left")), l.data("stellar-startingTop", l.css("top"))), e = l.position().left, i = l.position().top, s = "auto" === l.css("margin-left") ? 0 : parseInt(l.css("margin-left"), 10), o = "auto" === l.css("margin-top") ? 0 : parseInt(l.css("margin-top"), 10), r = l.offset().left - s, a = l.offset().top - o, l.parents().each(function () {
                    var t = f(this);
                    if (!0 === t.data("stellar-offset-parent")) return h = d, c = p, n = t, !1;
                    d += t.position().left, p += t.position().top
                }), s = l.data("stellar-horizontal-offset") !== m ? l.data("stellar-horizontal-offset") : n !== m && n.data("stellar-horizontal-offset") !== m ? n.data("stellar-horizontal-offset") : u.horizontalOffset, o = l.data("stellar-vertical-offset") !== m ? l.data("stellar-vertical-offset") : n !== m && n.data("stellar-vertical-offset") !== m ? n.data("stellar-vertical-offset") : u.verticalOffset, u.particles.push({
                    $element: l,
                    $offsetParent: n,
            ...
            var t, d = this, p = this._getScrollLeft(), u = this._getScrollTop();
            this.backgrounds = [], this.options.parallaxBackgrounds && (t = this.$element.find("[data-stellar-background-ratio]"), this.$element.data("stellar-background-ratio") && (t = t.add(this.$element)), t.each(function () {
                var t, e, i, s, o, n = f(this), r = _(n), a = 0, l = 0, h = 0, c = 0;
                ...
                n.data("stellar-backgroundStartingLeft") ? g(n, n.data("stellar-backgroundStartingLeft"), n.data("stellar-backgroundStartingTop")) : (n.data("stellar-backgroundStartingLeft", r[0]), n.data("stellar-backgroundStartingTop", r[1])), t = "auto" === n.css("margin-left") ? 0 : parseInt(n.css("margin-left"), 10), e = "auto" === n.css("margin-top") ? 0 : parseInt(n.css("margin-top"), 10), i = n.offset().left - t - p, s = n.offset().top - e - u, n.parents().each(function () {
                    var t = f(this);
                    if (!0 === t.data("stellar-offset-parent")) return a = h, l = c, o = t, !1;
                    h += t.position().left, c += t.position().top
                }), t = n.data("stellar-horizontal-offset") !== m ? n.data("stellar-horizontal-offset") : o !== m && o.data("stellar-horizontal-offset") !== m ? o.data("stellar-horizontal-offset") : d.horizontalOffset, e = n.data("stellar-vertical-offset") !== m ? n.data("stellar-vertical-offset") : o !== m && o.data("stellar-vertical-offset") !== m ? o.data("stellar-vertical-offset") : d.verticalOffset, d.backgrounds.push({
                    $element: n,
                    $offsetParent: o,
            ...
            var t, e, i, s, o, n, r, a, l, h, c = this._getScrollLeft(), d = this._getScrollTop(), p = !0, u = !0;
            if (this.currentScrollLeft !== c || this.currentScrollTop !== d || this.currentWidth !== this.viewportWidth || this.currentHeight !== this.viewportHeight) {
                for (this.currentScrollLeft = c, this.currentScrollTop = d, this.currentWidth = this.viewportWidth, this.currentHeight = this.viewportHeight, h = this.particles.length - 1; 0 <= h; h--) e = (t = this.particles[h]).isFixed ? 1 : 0, a = this.options.horizontalScrolling ? (n = (c + t.horizontalOffset + this.viewportOffsetLeft + t.startingPositionLeft - t.startingOffsetLeft + t.parentOffsetLeft) * -(t.stellarRatio + e - 1) + t.startingPositionLeft) - t.startingPositionLeft + t.startingOffsetLeft : (n = t.startingPositionLeft, t.startingOffsetLeft), l = this.options.verticalScrolling ? (r = (d + t.verticalOffset + this.viewportOffsetTop + t.startingPositionTop - t.startingOffsetTop + t.parentOffsetTop) * -(t.stellarRatio + e - 1) + t.startingPositionTop) - t.startingPositionTop + t.startingOffsetTop : (r = t.startingPositionTop, t.startingOffsetTop), this.options.hideDistantElements && (u = !this.options.horizontalScrolling || a + t.width > (t.isFixed ? 0 : c) && a < (t.isFixed ? 0 : c) + this.viewportWidth + this.viewportOffsetLeft, p = !this.options.verticalScrolling || l + t.height > (t.isFixed ? 0 : d) && l < (t.isFixed ? 0 : d) + this.viewportHeight + this.viewportOffsetTop), u && p ? (t.isHidden && (this.options.showElement(t.$element), t.isHidden = !1), this._setPosition(t.$element, n, t.startingPositionLeft, r, t.startingPositionTop)) : t.isHidden || (this.options.hideElement(t.$element), t.isHidden = !0);
                for (h = this.backgrounds.length - 1; 0 <= h; h--) e = (i = this.backgrounds[h]).isFixed ? 0 : 1, s = this.options.horizontalScrolling ? (c + i.horizontalOffset - this.viewportOffsetLeft - i.startingOffsetLeft + i.parentOffsetLeft - i.startingBackgroundPositionLeft) * (e - i.stellarRatio) + "px" : i.startingValueLeft, o = this.options.verticalScrolling ? (d + i.verticalOffset - this.viewportOffsetTop - i.startingOffsetTop + i.parentOffsetTop - i.startingBackgroundPositionTop) * (e - i.stellarRatio) + "px" : i.startingValueTop, g(i.$element, s, o)
            }
        ...
        return e === m || "object" == typeof e ? this.each(function () {
            f.data(this, "plugin_" + s) || f.data(this, "plugin_" + s, new h(this, e))
        }) : "string" == typeof e && "_" !== e[0] && "init" !== e ? this.each(function () {
            var t = f.data(this, "plugin_" + s);
            t instanceof h && "function" == typeof t[e] && t[e].apply(t, Array.prototype.slice.call(i, 1)), "destroy" === e && f.data(this, "plugin_" + s, null)
        }) : void 0
    }, f[s] = function (t) {
        var e = f(o);
        return e.stellar.apply(e, Array.prototype.slice.call(arguments, 0))
    }, f[s].scrollProperty = a, f[s].positionProperty = l, o.Stellar = h
    ...
    function i(t) {
        this.element = t, this.Adapter = u.Adapter, this.adapter = new this.Adapter(t), this.key = "waypoint-context-" + s, this.didScroll = !1, this.didResize = !1, this.oldScroll = {
            x: this.adapter.scrollLeft(),
            y: this.adapter.scrollTop()
        }, this.waypoints = {
            vertical: {},
            horizontal: {}
        }, t.waypointContextKey = this.key, o[t.waypointContextKey] = this, s += 1, u.windowContext || (u.windowContext = !0, u.windowContext = new i(window)), this.createThrottledScrollHandler(), this.createThrottledResizeHandler()
    }

    var s = 0, o = {}, u = window.Waypoint, t = window.onload;
    i.prototype.add = function (t) {
        ...
        this.adapter.on("scroll.waypoints", function () {
            e.didScroll && !u.isTouch || (e.didScroll = !0, u.requestAnimationFrame(t))
        })
        ...
        for (e in this.handleScroll(), t = {
            ...
            for (n in this.waypoints[e]) {
                var a, l = this.waypoints[e][n], h = l.options.offset, c = l.triggerPoint, d = 0, p = null == c;
    ...
    h.fn.countdown = function (t, n) {
        var r = h(this), a = {date: null, format: null};

        function e() {
            var t = Date.parse(a.date) / 1e3, e = Math.floor(h.now() / 1e3);
    ...
    var f, s, m, o, g, e, l = "Close", _ = "BeforeClose", v = "MarkupParse", y = "Open", b = ".mfp", w = "mfp-ready",
        i = "mfp-removing", r = "mfp-prevent-close", a = !!window.jQuery, x = h(window);
    t.prototype = {
        constructor: t, init: function () {
            ...
            if (!f.isOpen) {
                f.types = [], g = "", t.mainEl && t.mainEl.length ? f.ev = t.mainEl.eq(0) : f.ev = m, t.key ? (f.popupsCache[t.key] || (f.popupsCache[t.key] = {}), f.currTemplate = f.popupsCache[t.key]) : f.currTemplate = {}, f.st = h.extend(!0, {}, h.magnificPopup.defaults, t), f.fixedContentPos = "auto" === f.st.fixedContentPos ? !f.probablyMobile : f.st.fixedContentPos, f.st.modal && (f.st.closeOnContentClick = !1, f.st.closeOnBgClick = !1, f.st.showCloseBtn = !1, f.st.enableEscapeKey = !1), f.bgOverlay || (f.bgOverlay = d("bg").on("click" + b, function () {
                    f.close()
                }), f.wrap = d("wrap").attr("tabindex", -1).on("click" + b, function (t) {
                ...
                p("BeforeOpen"), f.st.showCloseBtn && (f.st.closeBtnInside ? (c(v, function (t, e, i, s) {
                    i.close_replaceWith = u(s.type)
                }), g += " mfp-close-btn-in") : f.wrap.append(u())), f.st.alignTop && (g += " mfp-align-top"), f.fixedContentPos ? f.wrap.css({
                ...
                return f.isIE7 && (l += " mfp-ie7"), l && f._addClassToMFP(l), f.updateItemHTML(), p("BuildControls"), h("html").css(a), f.bgOverlay.add(f.wrap).prependTo(f.st.prependTo || h(document.body)), f._lastFocusedEl = document.activeElement, setTimeout(function () {
                    f.content ? (f._addClassToMFP(w), f._setFocus()) : f.bgOverlay.addClass(w), m.on("focusin" + b, f._onFocusIn)
                }, 16), f.isOpen = !0, f.updateSize(r), p(y), t
            }
            f.updateItemHTML()
        }, close: function () {
            f.isOpen && (p(_), f.isOpen = !1, f.st.removalDelay && !f.isLowIE && f.supportsTransition ? (f._addClassToMFP(i), setTimeout(function () {
                f._close()
            ...
            var e;
            f.isIOS ? (e = document.documentElement.clientWidth / window.innerWidth, e = window.innerHeight * e, f.wrap.css("height", e), f.wH = e) : f.wH = t || x.height(), f.fixedContentPos || f.wrap.css("height", f.wH), p("Resize")
        }, updateItemHTML: function () {
            var t = f.items[f.index];
            f.contentContainer.detach(), f.content && f.content.detach(), t.parsed || (t = f.parseEl(f.index));
            var e = t.type;
            p("BeforeChange", [f.currItem ? f.currItem.type : "", e]), f.currItem = t, f.currTemplate[e] || (i = !!f.st[e] && f.st[e].markup, p("FirstMarkupParse", i), f.currTemplate[e] = !i || h(i)), o && o !== t.type && f.container.removeClass("mfp-" + o + "-holder");
            var i = f["get" + e.charAt(0).toUpperCase() + e.slice(1)](t, f.currTemplate[e]);
            f.appendContent(i, e), t.preloaded = !0, p("Change", t), o = t.type, f.container.prepend(f.contentContainer), p("AfterChange")
        }, appendContent: function (t, e) {
            (f.content = t) ? f.st.showCloseBtn && f.st.closeBtnInside && !0 === f.currTemplate[e] ? f.content.find(".mfp-close").length || f.content.append(u()) : f.content = t : f.content = "", p("BeforeAppend"), f.container.addClass("mfp-" + e + "-holder"), f.contentContainer.append(f.content)
        }, parseEl: function (t) {
            var e, i = f.items[t];
            ...
            return i.type = e || f.st.type || "inline", i.index = t, i.parsed = !0, f.items[t] = i, p("ElementParse", i), f.items[t]
            ...
            var i;
            f.preloader && (s !== t && f.container.removeClass("mfp-s-" + s), e || "loading" !== t || (e = f.st.tLoading), p("UpdateStatus", i = {
                status: t,
                text: e
            ...
            var n;
            e.data && (t = h.extend(e.data, t)), p(v, [o, t, e]), h.each(t, function (t, e) {
                return void 0 === e || !1 === e || void (1 < (n = t.split("_")).length ? 0 < (i = o.find(b + "-" + n[0])).length && ("replaceWith" === (s = n[1]) ? i[0] !== e[0] && i.replaceWith(e) : "img" === s ? i.is("img") ? i.attr("src", e) : i.replaceWith(h("<img>").attr("src", e).attr("class", i.attr("class"))) : i.attr(n[1], e)) : o.find(b + "-" + t).html(e));
                var i, s
            })
        ...
        n();
        var e, i, s, o = h(this);
        return "string" == typeof t ? "open" === t ? (e = a ? o.data("magnificPopup") : o[0].magnificPopup, i = parseInt(arguments[1], 10) || 0, s = e.items ? e.items[i] : (s = o, e.delegate && (s = s.find(e.delegate)), s.eq(i)), f._openClick({mfpEl: s}, o, e)) : f.isOpen && f[t].apply(f, Array.prototype.slice.call(arguments, 1)) : (t = h.extend(!0, {}, t), a ? o.data("magnificPopup", t) : o[0].magnificPopup = t, f.addGroup(o, t)), o
    };
    ...
    h.magnificPopup.registerModule(S, {
        ...
        proto: {
            initInline: function () {
                ...
                if (k(), t.src) {
                    var i, s = f.st.inline, o = h(t.src);
                    return o.length ? ((i = o[0].parentNode) && i.tagName && ($ || (C = s.hiddenClass, $ = d(C), C = "mfp-" + C), T = o.after($).detach().removeClass(C)), f.updateStatus("ready")) : (f.updateStatus("error", s.tNotFound), o = h("<div>")), t.inlineElement = o
                }
    ...
    h.magnificPopup.registerModule(z, {
        options: {
            ...
            initAjax: function () {
                f.types.push(z), F = f.st.ajax.cursor, c(l + "." + z, E), c("BeforeChange." + z, E)
            }, getAjax: function (s) {
                F && h(document.body).addClass(F), f.updateStatus("loading");
                var t = h.extend({
                    url: s.src, success: function (t, e, i) {
                        i = {data: t, xhr: i};
                        p("ParseAjax", i), f.appendContent(h(i.data), z), s.finished = !0, P(), f._setFocus(), setTimeout(function () {
                            f.wrap.addClass(w)
        ...
        options: {
            ...
            initImage: function () {
                ...
                f.types.push("image"), c(y + e, function () {
                    ...
                    t.cursor && h(document.body).removeClass(t.cursor), x.off("resize" + b)
                ...
                t.img && (t.hasSize = !0, A && clearInterval(A), t.isCheckingImgSize = !1, p("ImageHasSize", t), t.imgHidden && (f.content && f.content.removeClass("mfp-loading"), t.imgHidden = !1))
            }, findImageSize: function (e) {
                var i = 0, s = e.img[0], o = function (t) {
                    A && clearInterval(A), A = setInterval(function () {
                        return 0 < s.naturalWidth ? void f._onImageHasSize(e) : (200 < i && clearInterval(A), void (3 === ++i ? o(10) : 40 === i ? o(50) : 100 === i && o(500)))
                    }, t)
                };
                o(1)
            }, getImage: function (t, e) {
                var i, s = 0, o = function () {
                    t && (t.img[0].complete ? (t.img.off(".mfploader"), t === f.currItem && (f._onImageHasSize(t), f.updateStatus("ready")), t.hasSize = !0, t.loaded = !0, p("ImageLoadComplete")) : ++s < 200 ? setTimeout(o, 100) : n())
                }, n = function () {
                ...
                return a.length && ((i = document.createElement("img")).className = "mfp-img", t.el && t.el.find("img").length && (i.alt = t.el.find("img").attr("alt")), t.img = h(i).on("load.mfploader", o).on("error.mfploader", n), i.src = t.src, a.is("img") && (t.img = t.img.clone()), 0 < (i = t.img[0]).naturalWidth ? t.hasSize = !0 : i.width || (t.hasSize = !1)), f._parseMarkup(e, {
                    title: function (t) {
    ...
    h.magnificPopup.registerModule(L, {
        options: {
            ...
            initIframe: function () {
                f.types.push(L), c("BeforeChange", function (t, e, i) {
                    e !== i && (e === L ? I() : i === L && I(!0))
                }), c(l + "." + L, function () {
                    I()
                })
    ...
    h.magnificPopup.registerModule("gallery", {
        options: {
            ...
            initGallery: function () {
                var n = f.st.gallery, t = ".mfp-gallery";
                return f.direction = !0, !(!n || !n.enabled) && (g += " mfp-gallery", c(y + t, function () {
                    ...
                    var t, e;
                    1 < f.items.length && n.arrows && !f.arrowLeft && (e = n.arrowMarkup, t = f.arrowLeft = h(e.replace(/%title%/gi, n.tPrev).replace(/%dir%/gi, "left")).addClass(r), e = f.arrowRight = h(e.replace(/%title%/gi, n.tNext).replace(/%dir%/gi, "right")).addClass(r), t.click(function () {
                        f.prev()
                    }), e.click(function () {
                        f.next()
                ...
                var e;
                t = M(t), f.items[t].preloaded || ((e = f.items[t]).parsed || (e = f.parseEl(t)), p("LazyLoad", e), "image" === e.type && (e.img = h('<img class="mfp-img" />').on("load.mfploader", function () {
                    e.hasSize = !0
    ...
    h.magnificPopup.registerModule(D, {
        options: {
            ...
            initRetina: function () {
                var i, s;
                1 < window.devicePixelRatio && (i = f.st.retina, s = i.ratio, 1 < (s = isNaN(s) ? s() : s) && (c("ImageHasSize." + D, function (t, e) {
    ...
    o.fn.niceSelect = function (t) {
        ...
        this.hide(), this.each(function () {
            ...
            var e, i = o(this), s = o(i.find(".focus") || i.find(".list .option.selected"));
    ...
    "use strict";
    var e, i = 0,
        s = (e = /msie\s\d+/i, 0 < (t = t.userAgent).search(e) && e.exec(t).toString().split(" ")[1] < 9 && (r("html").addClass("lt-ie9"), !0));
    Function.prototype.bind || (Function.prototype.bind = function (i) {
        ...
        var n = o.call(arguments, 1), r = function () {
            if (this instanceof r) {
                ...
                var e = new t, t = s.apply(e, n.concat(o.call(arguments)));
    ...
    function o(t, e, i) {
        ...
        var s, o, n = this.$cache.input, i = n.prop("value"), t = {
            skin: "flat",
            type: "single",
            min: 10,
            max: 100,
        ...
        i !== h && "" !== i && ((i = i.split(s.input_values_separator || e.input_values_separator || ";"))[0] && i[0] == +i[0] && (i[0] = +i[0]), i[1] && i[1] == +i[1] && (i[1] = +i[1]), e && e.values && e.values.length ? (t.from = i[0] && e.values.indexOf(i[0]), t.to = i[1] && e.values.indexOf(i[1])) : (t.from = i[0] && +i[0], t.to = i[1] && +i[1])), r.extend(t, e), r.extend(t, s), this.options = t, this.update_check = {}, this.validate(), this.result = {
    ...
    o.prototype = {
        init: function (t) {
            ...
            2 !== e.button && ("both" === t && this.setTempMinInterval(), t = t || (this.target || "from"), this.current_plugin = this.plugin_count, this.target = t, this.is_active = !0, this.dragging = !0, this.coords.x_gap = this.$cache.rs.offset().left, this.coords.x_pointer = i - this.coords.x_gap, this.calcPointerPercent(), this.changeLevel(t), s && r("*").prop("unselectable", !0), this.$cache.line.trigger("focus"), this.updateScene())
            ...
            if (this.options && (this.calc_count++, 10 !== this.calc_count && !t || (this.calc_count = 0, this.coords.w_rs = this.$cache.rs.outerWidth(!1), this.calcHandlePercent()), this.coords.w_rs)) {
                ...
                switch ("both" === this.target && (this.coords.p_gap = 0, e = this.getHandleX()), "click" === this.target && (this.coords.p_gap = this.coords.p_handle / 2, e = this.getHandleX(), this.options.drag_interval ? this.target = "both_one" : this.target = this.chooseHandle(e)), this.target) {
                    ...
                    case"both_one":
                        if (this.options.from_fixed || this.options.to_fixed) break;
                        var n = this.convertToRealPercent(e), i = this.result.from_percent,
                            s = this.result.to_percent - i, o = s / 2, i = n - o, o = n + o;
            ...
            var t, e, i, s, o, n;
            this.options && (t = this.options.values.length, e = this.options.p_values, this.options.hide_from_to || ("single" === this.options.type ? (s = t ? this.decorate(e[this.result.from]) : (n = this._prettify(this.result.from), this.decorate(n, this.result.from)), this.$cache.single.html(s), this.calcLabels(), this.labels.p_single_left < this.labels.p_min + 1 ? this.$cache.min[0].style.visibility = "hidden" : this.$cache.min[0].style.visibility = "visible", this.labels.p_single_left + this.labels.p_single_fake > 100 - this.labels.p_max - 1 ? this.$cache.max[0].style.visibility = "hidden" : this.$cache.max[0].style.visibility = "visible") : (n = t ? (this.options.decorate_both ? (s = this.decorate(e[this.result.from]), s += this.options.values_separator, s += this.decorate(e[this.result.to])) : s = this.decorate(e[this.result.from] + this.options.values_separator + e[this.result.to]), o = this.decorate(e[this.result.from]), this.decorate(e[this.result.to])) : (n = this._prettify(this.result.from), i = this._prettify(this.result.to), this.options.decorate_both ? (s = this.decorate(n, this.result.from), s += this.options.values_separator, s += this.decorate(i, this.result.to)) : s = this.decorate(n + this.options.values_separator + i, this.result.to), o = this.decorate(n, this.result.from), this.decorate(i, this.result.to)), this.$cache.single.html(s), this.$cache.from.html(o), this.$cache.to.html(n), this.calcLabels(), i = Math.min(this.labels.p_single_left, this.labels.p_from_left), s = this.labels.p_single_left + this.labels.p_single_fake, o = this.labels.p_to_left + this.labels.p_to_fake, n = Math.max(s, o), this.labels.p_from_left + this.labels.p_from_fake >= this.labels.p_to_left ? (this.$cache.from[0].style.visibility = "hidden", this.$cache.to[0].style.visibility = "hidden", this.$cache.single[0].style.visibility = "visible", n = this.result.from === this.result.to ? ("from" === this.target ? this.$cache.from[0].style.visibility = "visible" : "to" === this.target ? this.$cache.to[0].style.visibility = "visible" : this.target || (this.$cache.from[0].style.visibility = "visible"), this.$cache.single[0].style.visibility = "hidden", o) : (this.$cache.from[0].style.visibility = "hidden", this.$cache.to[0].style.visibility = "hidden", this.$cache.single[0].style.visibility = "visible", Math.max(s, o))) : (this.$cache.from[0].style.visibility = "visible", this.$cache.to[0].style.visibility = "visible", this.$cache.single[0].style.visibility = "hidden"), i < this.labels.p_min + 1 ? this.$cache.min[0].style.visibility = "hidden" : this.$cache.min[0].style.visibility = "visible", n > 100 - this.labels.p_max - 1 ? this.$cache.max[0].style.visibility = "hidden" : this.$cache.max[0].style.visibility = "visible")))
        }, drawShadow: function () {
            var t, e, i = this.options, s = this.$cache, o = "number" == typeof i.from_min && !isNaN(i.from_min),
            ...
            var i = this.options.max - this.options.min, s = i / 100;
            ...
            var t = (o - s) / 100 * t + s, s = this.options.step.toString().split(".")[1],
            ...
            var s = this.convertToValue(t), t = this.options;
            ...
            if (this.options.grid) {
                var t, e, i, s, o, n, r = this.options, a = r.max - r.min, l = r.grid_num, h = 0, c = 4, d = "";
                for (this.calcGridMargin(), r.grid_snap && (l = a / r.step), 50 < l && (l = 50), i = this.toFixed(100 / l), 4 < l && (c = 3), 7 < l && (c = 2), 14 < l && (c = 1), 28 < l && (c = 0), t = 0; t < l + 1; t++) {
                    ...
                    d += '<span class="irs-grid-pol" style="left: ' + h + '%"></span>', n = this.convertToValue(h), d += '<span class="irs-grid-text js-grid-text-' + t + '" style="left: ' + h + '%">' + (n = r.values.length ? r.p_values[n] : this._prettify(n)) + "</span>"
                }
            ...
            for (var s, o, n = this.coords.big_num, r = 0; r < n && !(n <= (s = r + t / 2)); r += t) o = this.$cache.grid_labels[s][0], i[r] <= e[s] ? o.style.visibility = "visible" : o.style.visibility = "hidden"
        ...
        return this.each(function () {
            r.data(this, "ionRangeSlider") || r.data(this, "ionRangeSlider", new o(this, t, i++))
        })
    }, function () {
        for (var n = 0, t = ["ms", "moz", "webkit", "o"], e = 0; e < t.length && !l.requestAnimationFrame; ++e) l.requestAnimationFrame = l[t[e] + "RequestAnimationFrame"], l.cancelAnimationFrame = l[t[e] + "CancelAnimationFrame"] || l[t[e] + "CancelRequestAnimationFrame"];
        l.requestAnimationFrame || (l.requestAnimationFrame = function (t, e) {
            var i = (new Date).getTime(), s = Math.max(0, 16 - (i - n)), o = l.setTimeout(function () {
                t(i + s)
            }, s);
            return n = i + s, o
    ...
    return s = {}, o.m = i = [function (t, e, i) {
        ...
        }, i = i(2), n = i && i.__esModule ? i : {default: i};
        ...
        i.prototype = {
            on: function (t, e, i) {
                ...
                var i = this.e || (this.e = {}), s = i[t], o = [];
                if (s && e) for (var n = 0, r = s.length; n < r; n++) s[n].fn !== e && s[n].fn._ !== e && o.push(s[n]);
        ...
        t.exports = function (t, e, i) {
            ...
            if (h.node(t)) return a = e, l = i, (r = t).addEventListener(a, l), {
                destroy: function () {
                    r.removeEventListener(a, l)
                }
            };
            if (h.nodeList(t)) return s = t, o = e, n = i, Array.prototype.forEach.call(s, function (t) {
...
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {},
    Prism = function (l) {
        var h = /\blang(?:uage)?-([\w-]+)\b/i, e = 0, E = {
            manual: l.Prism && l.Prism.manual,
            disableWorkerMessageHandler: l.Prism && l.Prism.disableWorkerMessageHandler,
            util: {
                encode: function (t) {
                    return t instanceof F ? new F(t.type, E.util.encode(t.content), t.alias) : Array.isArray(t) ? t.map(E.util.encode) : t.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/\u00a0/g, " ")
                }, type: function (t) {
            ...
            languages: {
                extend: function (t, e) {
                    ...
                    var o, n = (s = s || E.languages)[i], r = {};
                    for (o in n) if (n.hasOwnProperty(o)) {
                        if (o == t) for (var a in e) e.hasOwnProperty(a) && (r[a] = e[a]);
            ...
            highlightElement: function (t, e, i) {
                for (var s, o = "none", n = t; n && !h.test(n.className);) n = n.parentNode;
                n && (o = (n.className.match(h) || [, "none"])[1].toLowerCase(), s = E.languages[o]), t.className = t.className.replace(h, "").replace(/\s+/g, " ") + " language-" + o, t.parentNode && (n = t.parentNode, /pre/i.test(n.nodeName) && (n.className = n.className.replace(h, "").replace(/\s+/g, " ") + " language-" + o));
            ...
            highlight: function (t, e, i) {
                ...
                return E.hooks.run("before-tokenize", i), i.tokens = E.tokenize(i.code, i.grammar), E.hooks.run("after-tokenize", i), F.stringify(E.util.encode(i.tokens), i.language)
            },
            matchGrammar: function (t, e, i, s, o, n, r) {
                for (var a in i) if (i.hasOwnProperty(a) && i[a]) {
                    if (a == r) return;
                    for (var l = i[a], l = "Array" === E.util.type(l) ? l : [l], h = 0; h < l.length; ++h) {
                        var c, d = l[h], p = d.inside, u = !!d.lookbehind, f = !!d.greedy, m = 0, g = d.alias;
                        ...
                        for (var _ = s, v = o; _ < e.length; v += e[_].length, ++_) {
                            ...
                            if (!(y instanceof F)) {
                                if (f && _ != e.length - 1) {
                                    ...
                                    for (var b = $.index + (u ? $[1].length : 0), w = $.index + $[0].length, x = _, k = v, C = e.length; x < C && (k < w || !e[x].type && !e[x - 1].greedy); ++x) (k += e[x].length) <= b && (++_, v = k);
                                ...
                                if ($) {
                                    u && (m = $[1] ? $[1].length : 0), w = (b = $.index + m) + ($ = $[0].slice(m)).length;
                                    var S = y.slice(0, b), P = y.slice(w), y = [_, T];
                                    S && (++_, v += S.length, y.push(S));
                                    S = new F(a, p ? E.tokenize($, p) : $, g, $, f);
                                    if (y.push(S), P && y.push(P), Array.prototype.splice.apply(e, y), 1 != T && E.matchGrammar(t, e, i, _, v, !0, a), n) break
                                } else if (n) break
                            }
                        }
                    }
        ...
        if (l.Prism = E, F.stringify = function (t, e) {
