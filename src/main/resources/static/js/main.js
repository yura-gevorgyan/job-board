...
!function (a) {
    ...
    a("#preloader").fadeOut("normall", function () {
        ...
        var s = 25 / a(window).height(), t = 25 / a(window).width();
        a(".object-move").mousemove(function (e) {
            var o = e.pageX - a(window).width() / 2, e = e.pageY - a(window).height() / 2, o = t * o * -1 - 25,
                e = s * e * -1 - 50;
            ...
            center: !1,
            margin: 30,
            responsive: {0: {items: 1, dots: !1}, 768: {items: 2}, 992: {items: 3}}
            ...
            center: !1,
            margin: 30,
            responsive: {0: {items: 1, dots: !1}, 768: {items: 2}, 992: {items: 2}, 1200: {items: 3}}
            ...
            center: !1,
            margin: 25,
            responsive: {0: {items: 1, dots: !1}, 768: {items: 2}, 992: {items: 2}}
            ...
            center: !1,
            margin: 30,
            responsive: {0: {items: 1, dots: !1}, 576: {items: 1}, 768: {items: 1}, 992: {items: 2}}
            ...
            center: !1,
            margin: 30,
            responsive: {0: {items: 1, dots: !1}, 576: {items: 1}, 768: {items: 2}, 992: {items: 2}, 1201: {items: 3}}
            ...
            center: !1,
            margin: 30,
            responsive: {0: {items: 1, dots: !1}, 768: {items: 2}, 991: {items: 2}, 1200: {items: 3}}
            ...
            center: !1,
            margin: 20,
            responsive: {0: {items: 1, dots: !1}, 767: {items: 2}, 992: {items: 3}, 1200: {items: 4}}
            ...
            tabidentify: "hor_1",
            activate: function (e) {
                var o = a(this), s = a("#nested-tabInfo");
                a("span", s).text(o.text()), s.show()
            }
        }), a(".countup").counterUp({delay: 25, time: 2e3}), a(".countdown").countdown({
